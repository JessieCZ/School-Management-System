			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 class="col-md-5">Enrolled Students</h1>
						</div>
				    </div>
								...
								<c:forEach items="${selectedCourseList}" var="item">
									<tr>
										...
										<c:if test="${!item.over}">
											<td>Pending</td>
											<td>
												<button class="btn btn-default btn-xs btn-info" onClick="location.href='${pageContext.request.contextPath}/teacher/mark?studentid=${item.studentid}&courseid=${item.courseid}'">Grade</button>
											</td>
										</c:if>
										<c:if test="${item.over}">
											<td>${item.mark}</td>
