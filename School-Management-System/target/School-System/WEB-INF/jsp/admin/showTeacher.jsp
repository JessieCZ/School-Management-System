...
<body>
				    ...
				    <div class="panel-footer">
						<c:if test="${pagingVO != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath}/admin/showTeacher?page=${pagingVO.upPageNo}">&laquo;Previous</a></li>
									...
									<li><a href="${pageContext.request.contextPath}/admin/showTeacher?page=${pagingVO.totalCount}">End&raquo;</a></li>
								</ul>
							</nav>
						</c:if>
				    </div>
	...
	<script type="text/javascript">
        ...
        function confirmd() {
            var msg = "Do you confirm to delete?";
            if (confirm(msg)==true){
                return true;
            }else{
                return false;
