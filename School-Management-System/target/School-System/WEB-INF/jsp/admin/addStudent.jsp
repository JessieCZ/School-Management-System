				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/addStudent" id="editfrom" method="post">
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="number" class="form-control" id="inputEmail3" name="userid" placeholder="Please enter ID"
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputPassword3" name="username" placeholder="Enter your name"
								  <c:if test='${student!=null}'>
